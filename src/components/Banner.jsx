          ...
          <Row>
            <Col lg={{ span: 10, offset: 1 }} className="text-center">
              <div className="banner-content">
                <span
                  className="meta_text text-uppercase text-primary d-inline-block mb-2"
                  data-aos="fade-up"
                ...
                >
                  Financial Services for <span>Metaverse and</span> Web3 Gaming
                  Platforms I
                </h1>
                <p
                  className="mb-4 mb-lg-5 fw-semibold"
                  data-aos="fade-up"
                  data-aos-duration="2300"
                >
                  XSTRATEGY is a Singapore-based Web3 Management Consulting firm
                  specializing in blockchain and cryptocurrency compliance,
                  fintech, digital finance, and payments.
                </p>
                <Button
                  variant="primary"
                  data-aos="fade-up"
